...
public class SaleService {
    ...
    private Client findClient(String identification) {
        ...
        throw new IllegalArgumentException("Client not found with identification: " + identification);
    }
    ...
    private Seller findSeller(String code) {
        ...
        throw new IllegalArgumentException("Seller not found with employee code: " + code);
    }
}
