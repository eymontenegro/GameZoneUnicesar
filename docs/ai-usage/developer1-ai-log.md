...
**2026-09-07**
**Query:** Difference between "Merge" and "Approve" on a GitHub Pull Request, and how to edit a PR's description after creation.
**Use type:** Git/GitHub workflow explanation
**How I used it:** Helped my team correctly complete the cross-review step required before merging my Pull Requests.

**2026-09-07**
**Query:** What to do after merging a Pull Request without another team member approving it first (process mistake).
**Use type:** Workflow correction
**How I used it:** Instead of reverting the merge, arranged for a retroactive approval on the already-merged PR, and adjusted my process going forward so another person approves before any future merge.
...
**2026-09-09**
**Query:** A Pull Request was accidentally opened with `main` as the base branch instead of `develop`.
**Use type:** Git/GitHub workflow correction
**How I used it:** Changed the PR's base branch to `develop` before requesting review, to keep feature work out of the stable `main` branch.
